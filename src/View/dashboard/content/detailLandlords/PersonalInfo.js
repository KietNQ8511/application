                    ...
                    <Grid container justify="flex-end" spacing={2}>
                        <Grid item>
                            <ButtonBase sx={{ width: 128, height: 128 }}>
                                <Avatar alt="Remy Sharp" src="https://bitly.com.vn/qnr7ei" sx={{ width: 100, height: 100 }} />
                            </ButtonBase>
                        </Grid>
                                ...
                                <Grid item justify="flex-end" xs>
                                    <MenuList>
                                        <MenuItem>
                                            ...
                                            <ListItemText>Đánh giá: 4 đánh giá</ListItemText>
                                        </MenuItem>
                                        <MenuItem>
                                            <ListItemIcon>
                                                <CalendarMonthIcon />
                                            </ListItemIcon>
                                            <ListItemText>Ngày tham gia: 01/01/2021</ListItemText>
                                        </MenuItem>
                                        <MenuItem>
                                            <List>
                                                <ListItem>
